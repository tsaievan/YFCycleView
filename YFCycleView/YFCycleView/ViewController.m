...
- (void)viewDidLoad {
    [super viewDidLoad];
    YFCycleView *cycleView = [[YFCycleView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, 200) urls:nil placeholderImage:[UIImage imageNamed:@"02.jpg"]];
